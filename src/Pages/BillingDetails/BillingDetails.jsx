              ...
              <div className="lg:col-span-2 max-lg:order-1 max-w-4xl mx-auto w-full">
                ...
                <form onSubmit={handlePlaceOrder} className="lg:mt-12">
                  ...
                  <div className="flex flex-wrap gap-4 mt-8">
                    <button className="min-w-[150px] px-6 py-3.5 text-sm bg-gray-100 text-[#333] rounded-md hover:bg-gray-200">
                      Back
                    </button>
                    <button className="min-w-[150px] px-6 py-3.5 text-sm bg-[#333] text-white rounded-md hover:bg-[#111]">
                      Confirm payment $240
                    </button>
                  </div>
                </form>
